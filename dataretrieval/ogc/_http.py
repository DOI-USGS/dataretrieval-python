"""HTTP-level helpers for the OGC API engine.

Default request headers, USGS-aware error-message construction, ``Retry-After``
parsing, the typed non-200 raiser, and the mid-pagination failure message.
"""
