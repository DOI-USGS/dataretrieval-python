...
(:func:`~dataretrieval.waterdata.utils.get_ogc_data`) with
...
def get_ngwmn_sites(
    ...
    .. code::
        ...
        >>> df, md = dataretrieval.waterdata.get_ngwmn_sites(state_name="Wisconsin")

        >>> # Specific sites, geometry omitted
        >>> df, md = dataretrieval.waterdata.get_ngwmn_sites(
...
def get_ngwmn_water_level(
    ...
    .. code::
        ...
        >>> df, md = dataretrieval.waterdata.get_ngwmn_water_level(
...
def get_ngwmn_lithology(
    ...
    .. code::
        ...
        >>> df, md = dataretrieval.waterdata.get_ngwmn_lithology(
...
def get_ngwmn_well_construction(
    monitoring_location_id: str | Iterable[str] | None = None,
    monitoring_location_obs_number: str | Iterable[str] | None = None,
    ...
    .. code::
        ...
        >>> df, md = dataretrieval.waterdata.get_ngwmn_well_construction(
...
def get_ngwmn_providers(
    ...
    .. code::
        ...
        >>> df, md = dataretrieval.waterdata.get_ngwmn_providers(state="WI")

        >>> df, md = dataretrieval.waterdata.get_ngwmn_providers(
